...
import OverviewImage from "../assets/images/overview/1240x1240.png";
import LogoReactImage from "../assets/images/overview/logo-react.png";
import LogoVueImage from "../assets/images/overview/logo-vuejs.png";
import LogoAngularImage from "../assets/images/overview/logo-angular.png";
          ...
          <section className="md:pt-52 pt-36 h-auto relative flex items-center background-effect overflow-hidden 
            ...
            <div className="container relative z-1">
                <div className="grid grid-cols-1 text-center mt-5 relative">
                    ...
                    <img src={LogoReactImage} className="animate-[spin_20s_linear_infinite] absolute h-11 w-11 -top-16 left-0 right-0 mx-auto" alt=""/>
                </div>

                <div className="flex justify-center text-center relative">
                    <div className="relative">
                        <img src={OverviewImage} className="max-w-lg" alt=""/>
                        ...
                        <img src={LogoVueImage} className="animate-[spin_20s_linear_infinite] absolute h-11 w-11 top-16 ltr:md:-left-5 ltr:left-32 rtl:md:-right-5 rtl:right-32" alt=""/>
                        <img src={LogoAngularImage} className="animate-[spin_20s_linear_infinite] absolute h-11 w-11 -top-20 ltr:md:-right-5 ltr:right-32 rtl:md:-left-5 rtl:left-32" alt=""/>
                    </div>
