...
import LogoDarkImage from "../assets/images/logo-dark.png";
    ...
    return(
        ...
        <div className="container flex flex-wrap items-center justify-between">
            <Link to= "/index" className="navbar-brand md:me-8" href="index.html">
                <img src={LogoDarkImage} className="inline-block dark:hidden" alt=""/>
                <img src={LogoLightImage} className="hidden dark:inline-block" alt=""/>
            </Link>
