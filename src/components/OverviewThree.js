...
import OverviewImage from "../assets/images/overview/500x700.png";
        ...
        <section className="relative table w-full lg:py-60 py-36 bg-[url('../../assets/images/bg/bg3.jpg')] bg-no-repeat bg-center bg-cover" id="home">
            ...
            <div className="container">
                <div className="grid grid-cols-1 text-center mt-5 relative">
                    <img src={OverviewImage} className="rounded-full h-28 w-28 mx-auto wow animate__animated animate__fadeInUp" data-wow-delay=".1s" alt=""/>
